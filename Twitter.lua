...
local oAuth = require "scripts.oAuth"
local json = require("json")

-- Fill in the following fields from your Twitter app account
consumer_key = "gJF4bQkuD9kDCwoXXPgQ3tcPb" -- key string goes here
consumer_secret = "WQ4IqSOGlBAgviCe1jeqhyMligWhTLuxFo6VQURfDUVexIrGUe" -- secret string goes here
